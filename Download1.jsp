...
<table width="478" border="0" align="center">
	...
	<tr>
		<td height="34"><span class="style14">MAC <span class="style4 style2">-Key</span>1:-</span></td>
		<td><input name="t12" type="text" size="40" value="<%=mac1%>" /></td>
	</tr>
	<tr>
		<td height="34"><span class="style14">MAC <span class="style4 style2">-Key</span>2:-</span></td>
		<td><input name="t122" type="text" size="40" value="<%=mac2%>" /></td>
	</tr>
	<tr>
		<td height="34"><span class="style14">MAC <span class="style4 style2">-Key</span>3:-</span></td>
		<td><input name="t123" type="text" size="40" value="<%=mac3%>" /></td>
	</tr>
	<tr>
		<td height="34"><span class="style14">MAC <span class="style4 style2">-Key</span>4:-</span></td>
	...
	<tr>
		<td>
		<div align="right"><input type="submit" name="Submit" value="Download" /></div>		</td>
	</tr>
</table>
</form>
<%	
