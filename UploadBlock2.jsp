...
%>
						...
						try 
	{
		...
		Statement st21 = connection.createStatement();
			...
			Statement st2222 = connection.createStatement();
						st2222.executeUpdate("insert into  backupkeys(fname,ownername,skold,dt) values ('"
										+ file
										+ "','"
										+ owner
										+ "','"
...
<h2 class="style4">Data Uploaded Successfully !!!</h2>
