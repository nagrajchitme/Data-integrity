...
<title>Dynamic-Hash-Table Based Public Auditing</title>
...
<div class="main">
  <div class="header">
	...
	<div class="logo style1">
        <h3 class="style1 style2">Data Integrity Audit Scheme Based on Quad Merkle </h3>
        <h3 class="style1 style2">Tree and Blockchain </h3>
	</div>
      <div class="menu_nav">
        <ul>
