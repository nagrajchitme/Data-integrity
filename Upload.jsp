...
<head>
<title>Upload File's Bloacks::Data Integrity Audit Scheme Based on Quad Merkle Tree and Blockchain</title>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="598" border="1" align="center">
            ...
            <tr>
              <td><span class="style4 style2">Hash-Key1 :- </span></td>
              <td><input name="t4" type="text" id="t4" size="50" value="" readonly="readonly" /></td>
            </tr>
			<tr>
              <td><span class="style4 style2">Hash-Key2 :- </span></td>
              <td><input name="t4" type="text" id="t4" size="50" value="" readonly="readonly" /></td>
            </tr>
			<tr>
              <td><span class="style4 style2">Hash-Key3 :- </span></td>
              <td><input name="t4" type="text" id="t4" size="50" value="" readonly="readonly" /></td>
            </tr>
			<tr>
              <td><span class="style4 style2">Hash-Key4 :- </span></td>
              <td><input name="t4" type="text" id="t4" size="50" value="" readonly="readonly" /></td>
            </tr>
