...
String name=(String)application.getAttribute("owner");
	...
	%><h1>
         View Quad<br>
         Merkle Tree Ciphertext Blocks Details <span style="color:#FF00FF"> </span>
	...
	<td bgcolor="#FF0000"><span class="style1">HASH-Key1</span></td>
	<td bgcolor="#FF0000"><span class="style1">HASH-Key2</span></td>
	<td bgcolor="#FF0000"><span class="style1">HASH-Key3</span></td>
	<td bgcolor="#FF0000"><span class="style1">HASH-Key4</span></td>
