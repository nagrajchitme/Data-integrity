      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="FileRequest.jsp">Request File </a></li>
            <li><a href="ViewFileResponse.jsp">View File Response </a></li>
